...
dat <- read.csv("/Users/nicolekinlock/Documents/NetworkMetaAnalysis/Networks/Biomass/838_Goldberg_1991.csv")
...
write.table(x = dat, file = paste("/Users/nicolekinlock/Documents/NetworkMetaAnalysis/Networks/Biomass/Cntrl/", name, ".csv", sep = ""), sep = ",", row.names = FALSE)
